...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-[#141A21]">
      <Sidebar />
      <main className="min-h-screen flex flex-col transition-[margin] duration-300 ease-in-out" style={{ marginLeft: 'var(--sidebar-width)', background: 'var(--fs-gradient-content)' }}>
        <TopBar />
